...
import mioV273DraftingTables from './mio-v273-drafting-tables.js'

// https://vite.dev/config/
export default defineConfig({
  plugins: [mioV268Transform(), mioV268Hotfix(), mioV272DraftingFormatting(), mioV273DraftingTables(), react()],
})
