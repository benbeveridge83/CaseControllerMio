...
const PUBLICATION_COLUMNS='id,inventory_work_id,slug,title,authors_text,publication_year,journal_or_publisher,doi,source_type,admission_route,direct_child_outcome,included_nielsen_2018,country_text,citation_text,abstract_summary,overall_findings_summary,limitations_summary,what_it_supports,what_it_does_not_establish,finding_direction,topics,evidence_strength_score,impact_score,equal_parenting_relevance_score,historical_field_importance_score,score_notes,editorial_status,published_at,citation_verification,citation_count_current,citation_count_provider,citation_count_captured_at,citations_per_year,fwci_current,influential_citation_count_current,major_review_count,impact_data_completeness,analysis_completion_status,analysis_verified_at,internal_notes,inventory_raw,created_by,updated_by,created_at,updated_at'
const LIST_COLUMNS=`${PUBLICATION_COLUMNS},studies:research_studies(id,study_label,extraction_status,country_text,sample_size,child_age_text,age_min,age_max,parenting_time_definition,shared_time_min_percent,shared_time_max_percent,exact_or_near_50_50,comparator,study_design,outcomes_measured,controls_summary,longitudinal,pre_separation_controls,conflict_controls,ses_controls,effect_size_summary,result_direction,result_summary,key_limitation,causal_claim_strength,extraction_source_url,verified_at),access_links:research_access_links(id,link_type,url,access_status,license_text,redistribution_permitted,is_preferred,is_public,checked_at),metrics:research_metrics(id,provider,metric_type,metric_value,source_url,captured_at)`
