...
const allowedPublicationFields=new Set(['overall_findings_summary','limitations_summary','what_it_supports','what_it_does_not_establish','finding_direction','topics','citation_verification'])
...
export function proposedScores(publication,studies,scoreInputs={}){
 ...
 const relevance=relevanceScores[0]||calculateEqualParentingRelevance({source_type:publication.source_type,topic_text:(publication.topics||[]).join(' '),direct_child_outcome:publication.direct_child_outcome})
 let historical=null
