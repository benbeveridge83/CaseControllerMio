...
import {runWordExportCheck} from './drafting-word-export-check.mjs'
...
try{
 ...
 console.log('PASS: field labels, actual mouse-drag selector, source choice, both repeated-name occurrences, fields after chips, reopen/reload, file scoping, save failure recovery, original source bytes unchanged, no app disk writes')
 await runWordExportCheck({context,open,getPage:()=>page,states,matterId,errors,dialogs})
