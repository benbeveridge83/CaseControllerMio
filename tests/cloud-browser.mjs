...
try{
 ...
 await migration.page.reload();await migration.page.locator('[data-mio-cloud-phase="ready"][data-mio-cloud-pending="0"]').waitFor({timeout:45000});assert.deepEqual(migration.errors,[]);await migration.context.close()
